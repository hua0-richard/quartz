...
where $y$ is the output from the [[Concepts/Core/Machine Learning/Regression/Train Set|training data]] and $X\beta$ are feature and coefficient vectors respectively.
