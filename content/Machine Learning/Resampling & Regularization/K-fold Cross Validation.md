...
We choose a fold to use as the [[Validation Set |validation set]] and use the remaining folds as the training set. The loss is measured on the validation set and is recorded as $\text{Perf}_1$.
